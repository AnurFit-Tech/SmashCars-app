    ...
    public partial class supplier : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProducerProductId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProducerID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProducerProduct", x => x.ProducerProductId);
                    table.ForeignKey(
                        name: "FK_ProducerProduct_Producer_ProducerID",
                        column: x => x.ProducerID,
                        principalTable: "Producer",
                        principalColumn: "ProducerID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProducerProduct_Products_ProductID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProducerProduct_ProducerID",
                table: "ProducerProduct",
                column: "ProducerID");

            migrationBuilder.CreateIndex(
                name: "IX_ProducerProduct_ProductID",
                table: "ProducerProduct",
                column: "ProductID");
